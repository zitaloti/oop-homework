...
from rational_exceptions import RationalValueError
...
class RationalList:
    ...
    def __setitem__(self, index, value):
        if isinstance(value, (int, Rational)):
            ...
            raise RationalValueError("Only Rational or int values are allowed")
    ...
    def __add__(self, other):
        ...
        if isinstance(other, RationalList):
            ...
            raise RationalValueError("Can only concatenate with RationalList, Rational or int")
